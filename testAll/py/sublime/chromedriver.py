...
while flagall:
    try:
        ...
        time.sleep(3)
        # 保存解析滑块图片
        utlo = "C:\\Users\\honey\\Desktop\\ori.webp"
        utla = "C:\\Users\\honey\\Desktop\\after.webp"
        ...
        part1.save("C:\\Users\\honey\\Desktop\\oritest.webp", "WEBP")
        ...
        part1.save("C:\\Users\\honey\\Desktop\\aftertest.webp", "WEBP")

        # 计算滑块距离
        ori = Image.open("C:\\Users\\honey\\Desktop\\oritest.webp")
        after = Image.open("C:\\Users\\honey\\Desktop\\aftertest.webp")
        ...
        for i in range(0, width):
            for j in range(0, height):
                for x in range(0, 2):
                    if abs(ori.getpixel((i, j))[x] - after.getpixel((i, j))[x]) > 120:
                        distance = (i - 7)
        ...
        # index = 0
        ActionChains(browser).move_to_element(slider).click_and_hold().perform()
        l = 0
        while l < distance:
            # index += 1
            # if index == 1:
            ...
            l += r
            if l >= distance:
                # chain.move_by_offset(r, 0)
                ActionChains(browser).move_by_offset(r, 0).perform()
                backdis = distance - l
                # time.sleep(random.uniform(0.5, 1))
                # chain.move_by_offset(backdis, 0)
                ActionChains(browser).move_by_offset(backdis, 0).perform()
                # print(r)
                # print(m)
                break
            # if index == 1:
