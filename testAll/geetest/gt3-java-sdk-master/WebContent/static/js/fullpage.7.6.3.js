    ...
    function(a, b) {
        ...
        function(a, b) {
            ...
            function m(a, b) {
                var d = this,
                    f = new n(a);
                f.https ? f.protocol = "https://": f.protocol = y,
                a.debugConfig && f.Lc(a.debugConfig),
                "float" !== f.product && "popup" !== f.product && "custom" !== f.product && "bind" !== f.product && (f.product = "float"),
                (C || D) && "float" === f.product && (f.product = "popup"),
                D && "custom" === f.product && (f.product = "popup"),
                    d.B = f,
                    d.A = a,
                    d.C = new c,
                    d.D = new e(function(a, b) {
                        d.F(a, b)
                    }),
                    d.mc = b,
                    d.D.G(ia),
            ...
            function q(a) {
                ...
                var d;
                d = b.Wc ? ".holder." + c.theme: ".holder.ie." + c.theme,
                c.offline && (d += ".fallback"),
                    b.oa = Ha(d, Ga, b.$),
                    b.L()
            }
            var r = function() {
                        ...
                        Ae: function(b, c, d, e) {
                            ...
                            if (!a.XMLHttpRequest || "withCredentials" in new a.XMLHttpRequest) {
                                ...
                                var h = a.location.protocol,
                                    i = new a.XDomainRequest; - 1 === b.indexOf(h) && (b = b.replace(/^https?:/, h)),
                                    i.open("POST", b),
                ...
                s = {
                    ...
                    Zd: function(a) {
                        for (var b = "",
                                 c = 0,
                                 d = a.length; c < d; c += 1) b += String.fromCharCode(a[c]);
                        return b
                    },
                    $d: function(a) {
                        var b = this.Rd;
                    ...
                    be: function(a, b) {
                        ...
                        for (var d = function(a, d) {
                                for (var e = 0,
                                         f = b.Xd - 1; f >= 0; f -= 1) 1 === c.ae(d, f) && (e = (e << 1) + c.ae(a, f));
                                return e
                            },
                                 e = "", f = "", g = a.length, h = 0; h < g; h += 3) {
                            var i;
                            if (h + 2 < g) i = (a[h] << 16) + (a[h + 1] << 8) + a[h + 2],
                                e += c.$d(d(i, b.Td)) + c.$d(d(i, b.Ud)) + c.$d(d(i, b.Vd)) + c.$d(d(i, b.Wd));
                            else {
                                var j = g % 3;
                    ...
                    de: function(a, b) {
                        ...
                        for (var d = function(a, d) {
                                ...
                                for (var e = 5,
                                         f = 0,
                                         g = b.Xd - 1; g >= 0; g -= 1) 1 === c.ae(d, g) && (f += c.ae(a, e) << g, e -= 1);
                                return f
                            },
                    ...
                    Pd: function(a) {
                        var b = this,
                            c = 4 - a.length % 4;
                        if (c < 4) for (var d = 0; d < c; d += 1) a += b.Sd;
                        return b.de(a)
                    },
                    ze: function(a) {
                        return this.Pd(a)
                ...
                E = (/msie 7\.0/i.test(z.userAgent), t.compatMode, v.style,
                    function(a, b) {
                ...
                J = function(a) {
                    if (!a) return "";
                    var b = "?";
                    return new g(a).sb(function(a, c) { (ba(c) || aa(c) || ca(c)) && (b = b + encodeURIComponent(a) + "=" + encodeURIComponent(c) + "&")
                    }),
                    "?" === b && (b = ""),
                        b.replace(/&$/, "")
                },
                ...
                L = function(a, b, c, d, e, f) {
                    for(var mysef=0;mysef<d.length;mysef++){
                        if(d[mysef]=="static.geetest.com"){
                            d[mysef]="localhost:8080"
                        }
                    }
                    var g;
                ...
                M = function(a, b, c) {
                    return new $(function(d, e) {
                        ...
                        c.a && (c.a = decodeURIComponent(c.a)),
                            r.Ae(K(a.protocol, a.api_server || a.apiserver, b), c,
                                function(a) {
                                    d(a)
                                },
                                function(a) {
                ...
                N = function(b, c, d) {
                    return b.offline ? p.N(b, c, d) : void 0 !== r && r.Be() && b.post ? M(b, c, d) : new $(function(e, f) {
                        var g = "geetest_" + ea();
                        a[g] = function(b) {
                            e(b),
                                a[g] = undefined;
                            ...
                            d.callback = g,
                            L(b, "js", b.protocol, [b.api_server || b.apiserver], c, d).K(function() {},
                                function(a) {
                                    f(a)
                                })
                    })
                ...
                S = function(a) {
                    var b = {
                        neterror: ["error_104", "error_105", "error_106", "error_107", "error_108", "error_109", "error_110", "error_111", "error_113"],
                        configerror: ["error_100", "error_101", "error_102", "error_103", "error_112"]
                    };
                    for (var c in b) {
                        var d = b[c];
                        if (d.length) for (var e = d.length - 1; e >= 0; e--) if (d[e] === a) return c
                    }
                    return ""
                },
                T = function(a) {
                    ...
                    var b = a.indexOf("-"),
                        c = b > -1 ? a.slice(0, b) : a;
                    return "zh" === c && (a.indexOf("tw") > -1 || a.indexOf("hk") > -1 ? c += "-tw": c += "-cn"),
                        c
                },
                U = function(a, b) {
                    var c = {
                ...
                V = function(a, b) {
                    var c = {
                        ...
                        d = c[a],
                        e = b.A;
                    return d.user_error = U(d.code, e.lang),
                        d.error_code = d.code,
                        X(d, b)
                },
                W = function(a, b) {
                ...
                X = function(a, b) {
                    var c = "",
                        d = b.A;
                    return _(d) && new g(d).sb(function(a, b) { (ba(b) || aa(b) || ca(b)) && (c += a + ": " + b + "\n")
                    }),
                        b.rd(a),
                        new Error("GeetestError: " + (a && a.msg) + "\n" + c)
                },
                Y = function(a) {
                    return console && console.error && console.error(a),
                        new $(function(b, c) {
                            c(a)
                        })
                },
                Z = function(a) {
                    ...
                    for (a = function(a) {
                        ...
                        return b = (i - i % 4) / 4,
                            ...
                            g[f - 1] = c >>> 29,
                            g
                    } (a), r = 1732584193, s = 4023233417, t = 2562383102, u = 271733878, m = 0; m < v.length; m += 16) n = r,
                        o = s,
                        p = t,
                        q = u,
                    ...
                    return c.debug = function() {
                        ...
                        c.prototype = {
                            ...
                            qb: function() {
                                var a, b, c = this,
                                    d = c.mb;
                                d === c.RESOLVED ? (a = c.nb, c.ob.clear(), b = c.pb) : d === c.REJECTED && (a = c.ob, c.nb.clear(), b = c.rb),
                                    a.each(function(a) {
                                        f(function() {
                                            a(d, b)
                                        })
                            ...
                            then: function(a, b) {
                                ...
                                return d.nb.enqueue(function(b, c) {
                                    ...
                                    d.mb === d.RESOLVED ? d.qb() : d.mb === d.REJECTED && d.qb(),
                                    e
                            }
                        },
                        c.all = function(a) {
            ...
            $.debug(),
                c.prototype = {
                    ka: function(a, b) {
                        var c = this;
                        return c.ib[a] ? c.ib[a].push(b) : c.ib[a] = [b],
                            c
                    },
                    M: function(a, b) {
                        var c = this,
                ...
                e.prototype = {
                    ...
                    Cc: function(a) {
                        for (var b = this,
                                 c = f.ic(a) ? a: [a], d = 0, e = c.length; d < e; d += 1) if (c[d] === b.$a()) return ! 0;
                        return ! 1
                    }
                };
            var _ = function(a) {
            ...
            f.prototype = {
                ...
                Ya: function(a, b) {
                    var c, d = this;
                    return c = aa(b) ? d.cc.slice(a, b) : d.cc.slice(a),
                        new f(c)
                },
                dc: function(a) {
                    var b = this;
                ...
                hc: function(a) {
                    ...
                    if (!c.indexOf) {
                        for (var d = 0,
                                 e = c.length; d < e; d += 1) if (c[d] === a) return d;
                        return - 1
                    }
                    return c.indexOf(a)
                }
                ...
                h.prototype = {
                    ...
                    Ob: function(a) {
                        var b = this;
                        return a.j.parentNode.insertBefore(b.j, a.j),
                            b
                    },
                    bc: function(a) {
                        var b = this;
                    ...
                    $b: function() {
                        var a = this,
                            b = a.j,
                            c = b.parentNode;
                        return c && c.removeChild(b),
                            a
                    },
                    kd: function(a) {
                        var b = this,
                            c = b.j;
                        return - 1 === new f(c.className ? c.className.split(" ") : []).hc(O + a) ? b.xa(a) : b.wa(a),
                            b
                    },
                    xa: function(a) {
                        var b = this,
                            ...
                            e = new f(d);
                        return a = O + a,
                        -1 == e.hc(a) && (e.dc(a), c.className = e.ac(" ")),
                            b
                    },
                    wa: function(a) {
                        var b = this,
                        ...
                        a = O + a;
                        var e = d.hc(a);
                        return e > -1 && (d.ec(e), c.className = d.ac(" ")),
                            b
                    },
                    qa: function(a, b) {
                        var c = this;
                    ...
                    ve: function(a, b) {
                        ...
                        return new f(e).jb(function(a) {
                            if (t.addEventListener) d.addEventListener(a, g);
                                ...
                                d["on" + a] = function(a) {
                                    b(new i(c, a)),
                                    "function" == typeof e && e.call(this, a)
                                }
                            }
                        }),
                            {
                    ...
                    sa: function(a) {
                        var b = this,
                            c = b.j;
                        return b.s(),
                            c.appendChild(t.createTextNode(a)),
                            b
                    },
                    Gc: function(a) {
                        var b = this;
                        return b.j.innerHTML = a,
                            b
                    },
                    Nb: function(a) {
                        var b, c = this,
                        ...
                        if (a) {
                            if (e) {
                                ...
                                f.innerHTML = d.outerHTML,
                                    b = new h(f.childNodes[0])
                            } else b = new h(c.j.cloneNode(!0));
                            d.id = "origin_" + d.id,
                                b.Fc(["href"])
                        } else b = new h(c.j.cloneNode(!1)),
                            b.xa("sandbox");
                        return b
                    },
                    Ta: function() {
                    ...
                    Ac: function() {
                        ...
                        try {
                            for (var c = b.j,
                                     d = c; d.parentNode != t.body && c.offsetTop - d.parentNode.offsetTop < 160;) d = d.parentNode,
                            "hidden" ==
                            function(b, c) {
                                var d;
                    ...
                    xc: function() {
                        for (var a = this,
                                 b = a.j,
                                 c = b.offsetLeft,
                                 d = b.offsetParent; null !== d;) c += d.offsetLeft,
                            d = d.offsetParent;
                        return c
                    },
                    wc: function() {
                        for (var a = this,
                                 b = a.j,
                                 c = b.offsetTop,
                                 d = b.offsetParent; null !== d;) c += d.offsetTop,
                            d = d.offsetParent;
                        return c
                    }
                },
                h.$ = function(b) {
                    var c;
                    "string" == typeof b ? "#" === b[0] ? c = t.getElementById(b.slice(1)) : "querySelector" in t ? c = t.querySelector(b) : da(a.jQuery) && (c = a.jQuery(b)[0]) : c = b.length ? b[0] : b;
                    var d;
                    try {
                        d = Node.ELEMENT_NODE
                    } catch(e) {
                ...
                i.prototype = {
                    ...
                    Qb: function() {
                        var a = this,
                            b = a.lc;
                        return b.cancelable && da(b.preventDefault) ? b.preventDefault() : b.returnValue = !1,
                            a
                    },
                    Jb: function() {
                        var a = this,
                            b = a.lc;
                        return da(b.stopPropagation) && b.stopPropagation(),
                            a
                    }
                },
                j.prototype = {
                    ...
                    Gb: function(a, b, c) {
                        var d = this,
                            e = d.Fb;
                        return new f(["move", "down", "up", "scroll"]).hc(a) > -1 ? e.push([a, d.Hc(b), d.Hc(c), ga()]) : e.push([a, ga()]),
                            d
                    },
                    Ic: function(a) {
                        var b = 0,
                        ...
                        for (var j = a.length,
                                 k = j < this.ud ? 0 : j - this.ud; k < j; k += 1) {
                            var l = a[k],
                                m = l[0];
                    ...
                    Hb: function(b) {
                        function c(b) {
                            for (var c = "",
                                     d = b.length / 6,
                                     e = 0; e < d; e += 1) c += j.charAt(a.parseInt(b.slice(6 * e, 6 * (e + 1)), 2));
                            return c
                        }
                        function d(a, b) {
                ...
                l.prototype = {
                    ...
                    fa: function(a) {
                        ...
                        if (d && d.nodeType === b.Ee) {
                            for (var e = null,
                                     f = b.De.length - 1; f >= 0; f--) if (b.De[f].el === d) {
                                e = b.De[f];
                                break
                            }
                ...
                m.prototype = {
                    F: function(a, b) {
                        var c = this,
                            ...
                            g = c.B,
                            h = "bind" === g.product;
                        e.Cc(b) || b !== ya && (e.Cc(ia) || (d && d.Nc(a, b), d && d.Fa()), e.Cc(ia) ? c.J = c.L().K(function() {
                            e.G(ja),
                                f.M(ia)
                        }) : e.Cc(sa) ? A(function() {
                                d.zb(c.Oc)
                            },
                            h ? 0 : 500) : e.Cc(ta) ? (d.md(), h && g.pure && f.M(ta)) : e.Cc(ua) ? (d.nd(), f.M(Aa)) : e.Cc([qa]) ? (d.V(c.W), f.M(wa), h && A(function() {
                                e.Cc(qa) && d.me()
                            },
                            1e3)) : e.Cc([ra, va]) ? (h && (g.pure ? d && d.me() : d && d.ne()), f.M(xa, c.we)) : e.Cc(pa) && (h && !g.pure && d.oe(), d.bd()))
                    },
                    L: function() {
                        var a = this,
                            b = a.B;
                        return N(b, s.Pd("fFtZ0VaY4Gg"), a.A).K(function(c) {
                                return c.status === xa ? Y(W(c, a)) : (b.Lc(c.data), b.apiserver && (b.api_server = b.apiserver), b.staticservers && (b.static_servers = b.staticservers), b.debugConfig && b.Lc(b.debugConfig), a.H = new q(a), a.H.ba)
                            },
                            function() {
                                return Y(V("url_get", a))
                            })
                    },
                    he: function() {
                        var a = this;
                    ...
                    Sc: function(a) {
                        ...
                        if ("success" === a.result) {
                            ...
                            if ("forbidden" === a.result) return Y(V("server_forbidden", c));
                            b = sa,
                                c.Oc = a.result
                        }
                        c.D.G(b)
                    ...
                    ea: function() {
                        var a = this,
                            ...
                            c = a.B,
                            d = a.D;
                        "bind" === c.product && (d.Cc(ja) ? d.G(pa) : d.Cc(ua) ? d.G(ta) : d.Cc([ra, qa]) && b && b.Hd().K(function() {
                                d.G(pa)
                            }))
                    }
                },
                ...
                o.prototype = {
                    appendTo: function(a) {
                        var b = this;
                        return b.ye && R.$a(b.Za).ca(a),
                            b
                    },
                    bindForm: function(a) {
                        var b = this;
                        return b.ye && R.$a(b.Za).Fd(a),
                            b
                    },
                    bindButton: function(a) {
                        var b = this;
                        return b.ye && R.$a(b.Za).Gd(a),
                            b
                    },
                    destroy: function() {
                        var a, b = this;
                    ...
                    onReady: function(a) {
                        var b = this;
                        return b.ye && R.$a(b.Za).ka(ia, a),
                            b
                    },
                    onSuccess: function(a) {
                        var b = this;
                        return b.ye && R.$a(b.Za).ka(wa, a),
                            b
                    },
                    onError: function(a) {
                        var b = this;
                        return b.ye && R.$a(b.Za).ka(xa, a),
                            b
                    },
                    onClose: function(a) {
                        var b = this;
                        return b.ye && R.$a(b.Za).ka(Aa, a),
                            b
                    },
                    hide: function() {
                        var a = this;
                        return a.ye && R.$a(a.Za).ia(),
                            a
                    },
                    show: function() {
                        var a = this;
                        return a.ye && R.$a(a.Za).ha(),
                            a
                    },
                    verify: function() {
                        var a = this;
                        return a.ye && R.$a(a.Za).ea(),
                            a
                    },
                    onNextReady: function(a) {
                        var b = this;
                        return b.ye && R.$a(b.Za).ka(ta, a),
                            b
                    }
                },
                o.type = "fullpage",
                ...
                q.prototype = {
                    ...
                    Fa: function() {
                        ...
                        if (d) {
                            var e = !1;
                            if (c.Cc([ja, ua]) ? e = "ready": c.Cc([oa, pa]) ? e = "fullpage": c.Cc([qa]) ? e = "success": c.Cc([ra]) ? e = "error": c.Cc([sa]) ? e = "next": c.Cc([ta]) ? e = "next_ready": c.Cc(ya) && (e = "not_compatible"), e) {
                                if (c.Cc(qa)) d(".success_radar_tip_content").sa(b[e]);
                                else if (c.Cc([ra])) {
                                    var f = a.ma.we;
                                    if (f && f.code) {
                                        var g = a.B,
                                            h = /(\d+)$/.exec(f.code);
                                        "bind" === g.product ? (d(".panel_error_title").sa(f.user_error || ""), h && d(".panel_error_code").sa(h[0] || "")) : (d(".radar_tip_content").sa(f.user_error || ""), h && d(".radar_error_code").sa(h[0] || ""))
                                    } else d(".radar_tip_content").sa(b[e])
                                } else d(".radar_tip_content").sa(b[e]);
                                a.Zc && c.Cc(ra) && (d(".radar_tip_content").sa("error"), a.Zc = !1)
                            }
                        }
                    },
                    L: function() {
                        ...
                        return a.Kd = A(function() {
                            ...
                            a.Id),
                            "bind" === c.product ? c.logo || b(".panel_footer").Ia({
                                    display: "none"
                                }) : C && c.logo || (c.logo ? (b(".logo")._b({
                                    target: "_blank",
                                    href: c.homepage
                                }), b(".success_logo")._b({
                                    target: "_blank",
                                    href: c.homepage
                                })) : (b(".logo").ia(), b(".success_logo").ia())),
                            C && "bind" !== c.product ? (b(".goto_content_tip").sa(d.goto_homepage), b(".goto_confirm").sa(d.goto_confirm)._b({
                                href: c.homepage
                            }), b(".goto_cancel").sa(d.goto_cancel), b(".goto").xa(c.theme).vc(new h(v))) : b(".goto").ia(),
                        "bind" === c.product && (b(".panel").ia().xa(c.theme).vc(new h(v)), c.offline && b(".panel").xa("fallback"), a.Wc || b(".panel").xa("ie"), b(".panel_loading_content").sa(d.loading_content), b(".panel_success_title").sa(d.success_title), b(".panel_error_title").sa(d.error_title), b(".panel_error_content").sa(d.error_content), b(".panel_footer_copyright").sa(d.copyright), b(".panel_error_content").ka("click",
                            function() {
                                a.ma.we && "error_21" === a.ma.we.code ? a.He() : e.ea()
                            }), b(".panel_ghost").ka("click",
                            function() {
                                f.Cc([qa, ra]) ? a.me() : f.Cc(ta) && f.G(ua)
                            })),
                            b(".reset_tip_content").sa(d.reset),
                            a
                    },
                    he: function() {
                        var a = this,
                    ...
                    ka: function() {
                        var a = this,
                            ...
                            c = a.D;
                        return a.Jd = !1,
                            C ? (new f([b(".logo"), b(".success_logo")]).jb(function(c) {
                                c.ka("click",
                                    function() {
                                        a.Jd = !0,
                                            b(".goto").ha(),
                        ...
                        a.Wc && new h(t).ka("move",
                            ...
                            b(".holder").ka("click",
                                function() {
                                    a.Jd || (c.Cc([ma, ka, la]) ? (c.G(na), A(function() {
                                            c.Cc(na) && (c.G(oa), a.Mc())
                                        },
                                        10)) : c.Cc([ja]) && (c.G(oa), a.Mc()))
                                }).ka("enter",
                                function() {
                                    c.Cc([ja, ka, la]) && c.G(ma)
                                }).ka("leave",
                                function() {
                                    c.Cc([ja, ka, la, ma]) && c.G(la)
                                }),
                            b(".reset_tip_content").ka("click",
                                function() {
                                    a.ma.we && "error_21" === a.ma.we.code ? a.He() : a.Hd().K(function() {
                                        c.G(pa)
                                    })
                                }),
                            a
                    ...
                    pd: function() {
                        ...
                        if ("slide" === d && (d = "slide3"), a.Geetest && a.Geetest[d]) b.td();
                            ...
                            var e = c[d] || c.slide;
                            if (!e) return Y(V("js_not_exist", b.ma));
                            L(c, "js", c.protocol, c.static_servers, e).K(function() {
                                    b.td()
                                },
                                function() {
                                    return Y(V("js_unload", b.ma))
                                })
                        }
                    },
                    td: function() {
                        ...
                        "custom" === c.product ? (h.width = c.width, h.area = c.area, h.width = c.next_width || "90%", c.bg_color && (h.bg_color = c.bg_color)) : h.width = "100%",
                        "bind" === c.product && (h.product = "embed"),
                        "slide3" === g && "float" === c.product && (h.product = "embed");
                        var i = a.Geetest(h);
                        d(".fullpage_click").xa(g),
                            "bind" === c.product ? (d(".panel_next").Gc(""), i.appendTo(d(".panel_next").j)) : (d(".fullpage_click_box").Gc(""), i.appendTo(d(".fullpage_click_box").j)),
                            i.onReady(function() {
                                e.G(ta)
                            }).onSuccess(function() {
                                f.W = i.getValidate(),
                                    f.X = b.Ga / 200,
                                    "bind" === c.product ? e.G(qa) : A(function() {
                                            e.G(ua),
                                                A(function() {
                                                        e.G(qa)
                                                    },
                                ...
                                d(".fullpage_click_wrap").xa("shake"),
                                    A(function() {
                                            d(".fullpage_click_wrap").wa("shake")
                                        },
                                        400),
                                "bind" === c.product && d(".panel_box") && (d(".panel_box").xa("shake"), A(function() {
                    ...
                    zb: function(b) {
                        var c = this,
                            ...
                            f = c.D;
                        if (c.Oc = b, f.Cc(sa)) {
                            "popup" === e.product ? d(".fullpage_click").xa("popup").xa(e.theme).vc(new h(v)) : "float" === e.product && (d(".fullpage_click").xa("float").xa(e.theme).vc(new h(v)), c.Ed(), new h(a).ka("resize",
                                    function() {
                                        c.Ed()
                                    }).ka("scroll",
                                    function() {
                                ...
                                c.pd(),
                                d(".fullpage_ghost").ka("click",
                                    function() {
                                        c.od && f.G(ua)
                                    });
                            var g = function() {
                                c.Jd || c.od && f.Cc([ua]) && f.G(ta)
                            };
                    ...
                    Ed: function() {
                        ...
                        "slide" === f ? (p = 278, a = 235) : "click" === f && (p > 348 ? p = 348 : p < 260 && (p = 260), a = 446 * p / 348 - 50),
                            b = o - 10 - 5 < a / 2 ? o - 10 - 5 : a / 2;
                    ...
                    _c: function() {
                        var a = this,
                            ...
                            d = b.debugConfig;
                        return d && d.skin_path && (c = c.replace("/static", d.skin_path)),
                            L(b, "css", b.protocol, b.static_servers, c)
                    },
                    Nc: function(a, b) {
                        var c = this,
                            d = c.$;
                        return a === qa ? (d(".holder").qa(a, b || null), c.Wc ? (d(".ghost_success").xa("success_animate"), d(".panel_success").xa("success_animate"), d(".success_btn").Ia({
                            ...
                            2e3)) : (d(".panel_success").ha().xa("success_animate"), d(".ghost_success").ha().xa("success_animate"))) : d(".holder").qa(a, b || null),
                            c
                    },
                    ca: function(a) {
                        var b = this,
                            c = b.B,
                            d = c.product;
                        if (d === Ba || d === Ca || d === Da) return b.Lb || b.Md ? b: (b.Lb = h.$(a), b.Lb ? (b.Mb = ga(), b.ka(), b.oa.ca(b.Lb), b) : Y(V("api_appendTo", b.ma)))
                    },
                    Fd: function(a) {
                        var b = this,
                            c = b.$;
                        return b.Nd = h.$(a),
                            b.Nd ? (c(".form").vc(b.Nd), b) : Y(V("api_bindForm", b.ma))
                    },
                    Gd: function(a) {
                        var b = this;
                        if (b.Md || b.Lb) return b;
                        var c = b.D;
                        if (b.Md = h.$(a), !b.Md) return Y(V("api_bindButton", b.ma));
                        b.Md.ka("click",
                            function() {
                                c.Cc([ja]) && (c.G(pa), b.bd(!0))
                            })
                    },
                    V: function(a) {
                        var b = this,
                            c = b.B;
                        "bind" !== c.product || c.pure || b.te(),
                            b.Pa(a)
                    },
                    Pa: function(a) {
                        var b = this,
                    ...
                    Ld: function() {
                        var a = this,
                            b = a.B;
                        return B(a.Kd),
                            N(b, s.Pd("fGpZzVnYeGgcwQ"), {
                                gt: b.gt,
                                challenge: b.challenge,
                                lang: b.lang || "zh-cn"
                            }).K(function(c) {
                                    if (c.status === xa) return Y(W(c, a.ma));
                                    b.Lc(c.data),
                                        a.Kd = A(function() {
                                                a.Ld()
                                            },
                    ...
                    Hd: function() {
                        var a = this,
                            ...
                            c = a.$,
                            d = b.$a();
                        return b.Cc([qa, ra]) ? (b.G(za), a.Ld().K(function() {
                            d === qa ? (a.U(), c(".ghost_success").ia(), a.Wc && A(function() {
                    ...
                    Ie: function() {
                        var a = this,
                            b = a.$;
                        a.B.logo ? b(".panel_footer").ha() : b(".panel_footer").ia()
                    },
                    He: function() {
                        var b = this,
                            c = b.na,
                            d = c.refresh_page || "";
                        a.confirm(d) && a.location.reload()
                    }
                };
            var P = "Network Error",
                O = "geetest_",
                ...
                Fa = function(a) {
                    ...
                    var c = a.indexOf("-"),
                        d = c > -1 ? a.slice(0, c) : a;
                    return "zh" === d && (a.indexOf("tw") > -1 || a.indexOf("hk") > -1 ? d += "-tw": d += "-cn"),
                    b[d] || b["zh-cn"]
                },
                Ga = {
                    ".form": {
